...
const services = [
  ...
  { href: "/services#call-agents", label: "AI Call Agents" },
...
const social = [
  {
    href: "https://www.instagram.com/vertexa_solution",
    label: "Instagram",
    svg: (
  ...
  {
    href: "https://www.linkedin.com/company/vertexasolution",
    label: "LinkedIn",
    svg: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
  ...
  {
    href: "https://www.facebook.com/vertexasolution",
    label: "Facebook",
    svg: (
      <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-zinc-500 text-sm leading-relaxed mb-6">
              Custom AI automation, call agents, web development, and app development — built specifically for your business.
            </p>
            <div className="flex items-center gap-3">
              {social.map(({ href, label, svg }) => (
                <a
                  ...
                  aria-label={label}
                  className="w-9 h-9 rounded-lg bg-white/5 hover:bg-violet-500/20 hover:text-violet-400 flex items-center justify-center text-zinc-500 transition-all"
                >
                  {svg}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map(({ href, label }) => (
                <li key={label}>
                  <Link href={href} className="text-sm text-zinc-500 hover:text-violet-400 transition-colors">
                    {label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2 text-sm text-zinc-500">
                ...
                <a href="mailto:vertexasolution@gmail.com" className="hover:text-violet-400 transition-colors">
                  vertexasolution@gmail.com
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm text-zinc-500">
                <Phone size={14} className="text-violet-400 shrink-0" />
                <span>+92 318 6148231</span>
              </li>
            ...
            <Link
              href="/contact"
              className="mt-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-600/20 hover:bg-violet-600/30 text-violet-400 text-sm font-medium transition-all border border-violet-500/20"
            >
              Book a Free Call
            </Link>
          </div>
        ...
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-600">
            © {new Date().getFullYear()} Vertexa Solution. All rights reserved.
          </p>
