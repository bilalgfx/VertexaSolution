...
import { Search, ChevronDown, ChevronUp, Mail, Globe, DollarSign, Briefcase, Calendar } from 'lucide-react'
              ...
              <div key={sub.id} className="hover:bg-white/[0.02] transition-colors">
                ...
                {expandedId === sub.id && (
                  <div className="px-6 pb-5 pt-0">
                    <div className="ml-13 pl-13 border-t border-white/5 pt-4 grid sm:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        {sub.message && (
                          <div>
                            <div className="text-xs text-zinc-600 mb-1">Message</div>
                            <div className="text-sm text-zinc-300 bg-[#0d0d0d] rounded-xl p-3 leading-relaxed">
                              {sub.message}
                            </div>
                          </div>
                        )}
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={label} className="flex items-center gap-2 text-xs">
                            ...
                            {href ? (
                              <a href={href} target="_blank" rel="noopener noreferrer" className="text-violet-400 hover:text-violet-300 truncate">
                                {value}
                              </a>
                            ) : (
