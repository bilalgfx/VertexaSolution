...
import { Inbox, Eye, TrendingUp, ArrowRight, Clock, BarChart2 } from 'lucide-react'
    ...
    <div className="p-8">
      ...
      <div className="bg-[#111111] border border-white/5 rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between px-6 py-4 border-b border-white/5">
          ...
          <Link href="/admin/submissions" className="text-xs text-violet-400 hover:text-violet-300 flex items-center gap-1 transition-colors">
              ...
              <div key={sub.id} className="px-6 py-4 flex items-center gap-4 hover:bg-white/[0.02] transition-colors">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {sub.company && <span className="text-xs text-zinc-500 truncate hidden sm:block">— {sub.company}</span>}
                  </div>
